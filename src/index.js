...
import FilterContainer from './modules/filter/components/FilterContainer.vue'
import FilterCheckboxContainer from './modules/filter/components/FilterCheckboxContainer.vue'
const components = {
    Button,
    ButtonGroup,
    Badge,
