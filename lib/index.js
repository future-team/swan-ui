    ...
    computed: {
        ...
        totalItemChecked: function totalItemChecked() {
            ...
            if (this.activeItemGroupItems && this.activeItemGroupItems.itemList && this.activeItemGroupItems.itemList.length) {
                var validItemList = this.activeItemGroupItems.itemList.filter(function (item) {
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })), _vm._v(" "), _vm._l((_vm.filterData), function(item, index) {
    return _c('div', {
      key: index
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _vm._l((_vm.activeItemGroupItems.itemList), function(item, index) {
    return _c('item', {
      key: index,
      attrs: {
        "itemIndex": index,
